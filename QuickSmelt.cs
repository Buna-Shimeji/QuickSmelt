...
{
    [Info("Quick Smelt", "misticos, buna_shimeji", "5.1.6")]
    ...
    class QuickSmelt : RustPlugin
    {
        ...
        {
            private bool IsElectricOven { get; set; }
            ...
            private BaseOven Furnace
            {
                get
                {
                    if (_oven == null)
                    {
                        ...
                        IsElectricOven = Furnace.GetComponent<ElectricOven>() != null;
                    }
            ...
            public void Cook()
            {
                ...
                if (!IsElectricOven && itemBurnable == null)
                {
                    StopCooking();
                    return;
                }
            ...
            {
                if (!IsElectricOven && FindBurnable() == null)
                {
                ...
                if (IsElectricOven)
                {
                    var a = Furnace.GetComponent<ElectricOven>();
                    if (!a.CanRunWithNoFuel)
                    {
                        PrintDebug("No burnable.");
                        return;
                    }
